...
import dev.uraneptus.refinedmosaicblocks.platform.services.IPlatformHelper;
import dev.uraneptus.refinedmosaicblocks.platform.services.RegHelper;

import java.util.ServiceLoader;

public class RMBServices {
    ...
    public static <T> T load(Class<T> clazz) {
        ...
        RMBConstants.LOG.debug("Loaded {} for service {}", loadedService, clazz);
